...
4. `getUserVideos()` ფუნქციაში დავამატოთ ლოგიკა, რომ თუ აღნიშნული მეილით იუზერს გააჩნია ვიდეოები იმუშავოს ისე, როგორც წინა დავალებაში, ხოლო თუ არ გააჩნია ვიდეოები (მისი მასივი ცარიელია) მაშინ გაეშვას მეორე(ბოლოს დამატებული) callback ფუნქცია და არგუმენტად გადაეცეს string ტიპის ტექსტი მნიშვნელობით `"Videoს not found!"`
